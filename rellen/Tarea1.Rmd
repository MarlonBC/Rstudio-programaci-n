---
title: "Tarea 1, lo que se pudo recuperar"
...
```{r }
load("D:/Users/MARLON/Downloads/ei1012-1516-la-s1-datos.RData")
length(grupo)
View(grupo)
```
...
# Graficar los puntos en un plano utilizando RStudio.
  # 1.Graficar los puntos (1,1),(2,4),(3,9),(4,16),(5,25),(6,36),(7,49),(8,64),(9,81),(10,100)en 
...
plot(yad,Vad,type = "b",main = "Variación entre años",xlim =c(1959,2020))
```
# 14
```{r }
